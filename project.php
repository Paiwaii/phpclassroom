  ...
  <header>
    ...
    <div class="d-flex justify-content-end">
      <div class="card mb-3" style="max-width: 540px;">
        <div class="row g-0">
          <div class="col-md-4">
            <img src="profile.jpg" class="img-fluid rounded-start" alt="https://scontent.fbkk10-1.fna.fbcdn.net/v/t1.15752-9/271924960_969551987280164_8481456254140741165_n.jpg">
          </div>
          <div class="col-md-8">
            <div class="card-body">
              <h5 class="card-title">จัดทำโดย</h5>
              <p class="card-text">นางสาวสรัลพร สีป้อ </p>
              <p class="card-text"><small class="text-muted">ม.6/13 เลขที่ 26 , 55817</small></p>
            </div>
          </div>
        </div>
      </div>
